	...
	<table class="table table-hover table-condensed">
		...
		<tbody>
			<?php foreach ($mahasiswa as $mhs){
				...
				echo "</td><td>";
				echo "<a href='". base_url() ."index.php/Admin/formUpdateMahasiswa/". $mhs->nim ."' title='Update'><i class='icon-pencil'></i> Update</a></td><td>";
				echo "<a href='". base_url() ."index.php/Admin/deleteMahasiswa/". $mhs->nim ."' title='Delete'><i class='icon-remove'></i> Delete</a>";
				echo "</td></tr>";
			}
			?>
		</tbody>
		<tfoot>
			<form action="<?php echo base_url(); ?>index.php/Admin/insertMahasiswa" method="POST">
				<tr>
