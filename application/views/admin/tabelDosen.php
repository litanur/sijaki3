	...
	<table class="table table-hover table-condensed">
		...
		<tbody>
			<?php foreach ($dosen as $dsn){
				...
				echo "</td><td>";
				echo "<a href='". base_url() ."index.php/Admin/formUpdateDosen/". $dsn->kode_dosen ."' title='Update'><i class='icon-pencil'></i> Update</a></td><td>";
				echo "<a href='". base_url() ."index.php/Admin/deleteDosen/". $dsn->kode_dosen ."' title='Delete'><i class='icon-remove'></i> Delete</a>";
				echo "</td></tr>";
			}
			?>
		</tbody>
		<tfoot>
			<form action="<?php echo base_url(); ?>index.php/Admin/insertDosen" method="POST">
				<tr>
