	...
	<table class="table table-hover table-condensed">
		...
		<tbody>
			<?php foreach ($jadwal as $jdwl){
				...
				echo "</td><td>";
				echo "<a href='". base_url() ."index.php/Admin/formUpdateJadwal/". $jdwl->kode_jadwal ."' title='Update'><i class='icon-pencil'></i> Update</a>";
				echo "</td><td>";
				echo "<a href='". base_url() ."index.php/Admin/deleteJadwal/". $jdwl->kode_jadwal ."' title='Delete'><i class='icon-remove'></i> Delete</a>";
				echo "</td></tr>";
			}
			?>
		</tbody>
		<tfoot>
			<form action="<?php echo base_url(); ?>index.php/Admin/insertJadwal" method="POST">
				<tr>
