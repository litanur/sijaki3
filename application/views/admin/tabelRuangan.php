	...
	<table class="table table-hover table-condensed">
		...
		<tbody>
			<?php foreach ($ruangan as $ruang){
				...
				echo "</td><td>";
				echo "<a href='". base_url() ."index.php/Admin/formUpdateRuangan/". $ruang->kode_ruangan ."' title='Update'><i class='icon-pencil'></i> Update</a></td><td>";
				echo "<a href='". base_url() ."index.php/Admin/deleteRuangan/". $ruang->kode_ruangan ."' title='Delete'><i class='icon-remove'></i> Delete</a>";
				echo "</td></tr>";
			}
			?>
		</tbody>
		<tfoot>
			<form action="<?php echo base_url(); ?>index.php/Admin/insertRuangan" method="POST">
				<tr>
