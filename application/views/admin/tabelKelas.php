	...
	<table class="table table-hover table-condensed">
		...
		<tbody>
			<?php foreach ($kelas as $kls){
				...
				echo "</td><td>";
				echo "<a href='". base_url() ."index.php/Admin/formUpdateKelas/". $kls->kode_kelas ."' title='Update'><i class='icon-pencil'></i> Update</a>";
				echo "</td><td>";
				echo "<a href='". base_url() ."index.php/Admin/deleteKelas/". $kls->kode_kelas ."' title='Delete'><i class='icon-remove'></i> Delete</a>";
				echo "</td></tr>";
			}
			?>
		</tbody>
